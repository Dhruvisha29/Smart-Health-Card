      ...
      <div class="col-md-6 mx-auto">
        <div class="block text-center">
          ...
          <form class="text-left clearfix mt-30" action="index.html">
            ...
            <div class="form-group">	
                <textarea rows="10" cols="50" placeholder="Medicine Prescription" style="display:inline-block" required ></textarea>
	        </div>            

             
            <div class="form-group">
                <button type="submit" class="btn" style="display: inline-block;width:25%">Submit</button>
            </div>
